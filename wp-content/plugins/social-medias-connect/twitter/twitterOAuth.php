...
$APP_KEY='o6XA4qybgh1jR0nfzSNA';
$APP_SECRET='HCnTfIawOV1PqlZmX1zKX1HAQYXXWrRmYVYx1XAA';
...
class TwitterOAuth {
  ...
  function http($url, $method, $postfields = NULL){
		...
		if(!is_array($response))wp_die('你的主机不被支持，请联系你的主机商重新配置主机。<br/><br/>Powered by © <a href="http://www.qiqiboy.com/products/plugins/social-medias-connect">Social Medias Connect</a>');
