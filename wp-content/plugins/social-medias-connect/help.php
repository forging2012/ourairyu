...
<div class="wrap" style="-webkit-text-size-adjust:none;">
	...
	<div>
		...
		<h3>功能一：文章同步到各大微博</h3>
			<p>支持对新浪微博、腾讯微博、搜狐微博、网易微博、豆瓣、twitter的同步，并且可以同步文章中的图片。利用强大的自定义同步格式功能，你可以自由组织要同步的内容，包括标题、前缀、标题、摘要等。</p>
		<h3>功能二：微博连接登陆功能</h3>
...
<?php endif; ?>
	...
	<div>
		...
		<p>1.新增支持Follow5、饭否、嘀咕、做啥、人间网、人民微博等(逐步增加中)。<br/></p><br/>
		...
		<p><h3>支持我继续开发此插件</h3>
			方式一：支付宝捐助我：imqiqiboy#gmail.com <br/>
