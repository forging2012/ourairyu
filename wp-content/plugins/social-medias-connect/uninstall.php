<?php 
	...
	if($_POST['reset_option'] || $_POST['uninstall_unsend'] || $_POST['uninstall_send']){
		delete_option('smc_weibo_options');
		delete_option('smc_allowed_weibo');
		$weiboarray=array('qqweibo','sinaweibo','sohuweibo','163weibo','twitter','fanfou');
...
<div class="wrap" style="-webkit-text-size-adjust:none;">
	...
	<h2>卸载社交媒体连接插件</h2>
	<?php if($info){
		echo '<h3 style="color:red;">'.$info.'</h3>';
	} ?>
