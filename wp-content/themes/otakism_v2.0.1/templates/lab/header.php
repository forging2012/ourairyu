...
<html xmlns="http://www.w3.org/1999/xhtml"<?php if(is_home()) { echo 'class="home"'; } ?>>
	<head profile="http://gmpg.org/xfn/11">
		...
		<meta name="copyright" content="宅男的部屋 Otakism 版权所有" />

		<title><?php bloginfo('name'); ?><?php wp_title(); ?></title>
		<link rel="shortcut icon" href="<?php echo $ourai_wpurl; ?>/common/images/favicon.ico" />
			...
			<div id="header">
				<div class="top clearfix">
					<ul id="navigationGlobal">
						<li><a href="http://www.otakism.com/" title="聚合各站信息">引导页</a></li>
						<li><a href="http://www.otakism.com/otachan" title="致力于推广宅文化">多田酱</a></li>
						<li><a href="http://blog.otakism.com/" title="记录我的生活琐事">网络志</a></li>
						<li class="current"><a href="http://labs.otakism.com/" title="深入研究开发技术">实验室</a></li>
				...
				<div class="bottom clearfix">
					<ul id="navigationLocal">
						<li<?php if(is_home()) echo ' class=\'current_page_item\''; ?>><a href="<?php bloginfo('url'); ?>" title="博客首页">实验室首页</a></li>
						<?php wp_list_categories('title_li=0&orderby=name&hide_empty=0'); ?>
					</ul>
				</div>
			</div>
