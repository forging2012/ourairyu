...
// 开发模式下可以调试 JavaScript Revolution
if ( $oc_project->debug ) {
  array_push( $oc_res['js'], $oc_project->root . 'GitHub/Takara/src/install.js' );
}
      ...
      <div>
        <div id="extraModules">
          <div id="projectLinks" class="link-list">
            <b>特别企划</b>
            <ul>
              <li><a href="http://dev.ourai.ws/" rel="external nofollow">Developer Center</a></li>
