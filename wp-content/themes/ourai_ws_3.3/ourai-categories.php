...
?><a class="ico-hp" href="<?php bloginfo('url'); ?>" title="返回到首页">首页</a><span class="separator">&raquo;</span><a href="<?php echo site_url('/articles/'); ?>" title="查看全部文章">全部文章</a><span class="separator">&raquo;</span>全部类别<?php
}
...
function template_layout_main() {
	if ( have_posts() ) : the_post();
		...
		$categories = ourai_sort_categories( get_categories('hide_empty=1') );
